...
function loadActividades() {
  ...
  const actividades = [
    {
      id: 1,
      nombre: "Carga de carbón",
      descripcion: "Proceso de carga de carbón en camiones",
    },
    {
      id: 2,
      nombre: "Descarga de carbón",
      descripcion: "Proceso de descarga de carbón de vagones",
    },
    {
      id: 3,
      nombre: "Mantenimiento de equipos",
      descripcion: "Mantenimiento preventivo de maquinaria",
    },
  ];
    ...
    row.innerHTML = `
           ...
           <td>
                <div class="action-buttons">
                    <button class="edit-btn" onclick="editActividad(${actividad.id})"><i class="fas fa-edit"></i> </button>
                    <button class="delete-btn" onclick="deleteActividad(${actividad.id})"><i class="fas fa-trash"></i> </button>
                </div>
            </td>
        `;
